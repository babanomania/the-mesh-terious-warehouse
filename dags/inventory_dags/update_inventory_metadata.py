"""Airflow DAG to update OpenMetadata descriptions for inventory datasets.

This DAG updates the descriptions for:
- inventory.raw_inventory_movements (raw table)
- inventory.stg_inventory_movements (staging view/table)
- inventory.fact_inventory_movements (fact view/table)
...
def _ensure_lineage(
    ...
    db_name: str = "warehouse",
    upstream_schema: str = "inventory",
    downstream_schema: str = "inventory",
) -> None:
...
with DAG(
    dag_id="update_inventory_metadata",
    schedule="@daily",
    ...
    RAW_COLUMNS = [
        ...
        {"name": "movement_id", "dataType": "STRING", "description": "Inventory movement identifier."},
        {"name": "product_id", "dataType": "STRING", "description": "Product identifier."},
        {"name": "delta_qty", "dataType": "INT", "description": "Quantity delta (positive or negative)."},
        {"name": "source_type", "dataType": "STRING", "description": "Source of the inventory change."},
    ...
    update_raw = PythonOperator(
        task_id="update_raw_inventory_metadata",
        python_callable=_update_table_metadata,
        op_kwargs={
            "table_name": "raw_inventory_movements",

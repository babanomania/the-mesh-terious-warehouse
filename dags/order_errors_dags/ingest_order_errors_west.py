"""Ingest order error events from RabbitMQ to Iceberg for west region."""
...
with DAG(
    dag_id="ingest_order_errors_west",
    schedule="@hourly",
    start_date=days_ago(1),
    catchup=False,
    tags=["ingest", "order_errors", "west"],
    default_args={"owner": "data-eng", "retries": 1},
) as dag:
    build_ingest_operator(
        dag_id="ingest_order_errors_west",
        queue_name="errors_west",
...
logger.info("Configured ingest_order_errors_west DAG")

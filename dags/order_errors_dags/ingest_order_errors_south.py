"""Ingest order error events from RabbitMQ to Iceberg for south region."""
...
with DAG(
    dag_id="ingest_order_errors_south",
    schedule="@hourly",
    start_date=days_ago(1),
    catchup=False,
    tags=["ingest", "order_errors", "south"],
    default_args={"owner": "data-eng", "retries": 1},
) as dag:
    build_ingest_operator(
        dag_id="ingest_order_errors_south",
        queue_name="errors_south",
...
logger.info("Configured ingest_order_errors_south DAG")
